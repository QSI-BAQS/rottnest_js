 ...
 */
export type NoArchCallGraphEntry = {
	// cu_id: string
	id: string
	name: string
	description: string
...
export type NoArchCallGraph = {
	graph: Map<string, NoArchCallGraphEntry>
}

export function NoArchCallGraphDefault(): NoArchCallGraph {
