...
// /**
//  *
//  * RTCCommEvents is a collection of events that is relevant for the RottnestApplication
//  * Separate events can be separated into another container or context type
//  * That will be the focus.
//  * 
//  * 
//  */
// export const RTCCommEvents: CommEventOps<RottnestApplication> = {
//   recvSubType: {
//     evkey: MSG_REMAP['subtype'],
//     evtrigger: (appService: AppServiceClient, rtc: RottnestApplication, m: any) => {
...
//     evtrigger: (appService: AppServiceClient, _: RottnestApplication, m: any) => {
//       let someMsg = m 
// 				if(someMsg) {
...
//   recvErr: {
//     evkey: MSG_REMAP['err'],
//     evtrigger: (_: AppServiceClient, rtc: RottnestApplication, m: any) => {
...
//     evtrigger: (appService: AppServiceClient, _r: RottnestApplication, _m: any) => {
//       /*let kinds = appService
// 					.retrieveArgs(m);
// 				if(kinds) {
// 				selfRef
...
// 	{
// 		opkey: "initial",
// 		operation: (appService: AppServiceClient, _rtc: RottnestApplication) => {
...
// /**
//  * CommunicationActions for RottnestApplication, allows one
//  * to define it in a file and pass it to where it is needed
//  */
// export const RTCCommActions
//   = CommsActions.MakeCommsWith<RottnestApplication>(RTCCommEvents);
...
// 	= CommOpQueue.MakeDispatchWith<RottnestApplication>(RTCDispatchOperations)
