import { RottRunResultMSG } from "../net/AppServiceMessage.ts";
...
declare class AppServiceMessage {
...
export declare class AppServiceClient {
  consumeFromQueue(): void;

  runResult(msg: RottRunResultMSG): void;

  enqueueMessage(msg: string): void;

  isConnected(): boolean;

  hookContext(ctx: ASContextHook, evKind: string): void;

  sendObj(message:string, payload: any): void;

  sendMessage(message: string): void;
  
	registerReciverKinds(evKind: string, 
			     callback: ASRecvCallback): void;
};
