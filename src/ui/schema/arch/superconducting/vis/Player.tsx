...
from "./VisualiserObjects.tsx";

import {
  OnRangeChange,
  OnVisualiserExportJSON,
  OnVisualiserFrameNext,
  OnVisualiserFramePrev,
  OnVisualiserPlay,
  OnVisualiserReset,
  OnVisualiserSaveAnimation,
  OnVisualiserSaveFrame
} from "./VisualiserEvents.ts";


// TODO: This pathing is crap
...
export class SchedulerVisualiser extends React.Component<SchedulerVisProps,
	...
	/**
	 * Changes the frame of the lattice player
	 */
  ...
  //
  // Render method to return the visual instance of each part
  // of the animation
  // 
	render() {
		const data = this.state.data;
    ...
    //
    // MouseMove handler that is defined within
    // the render function, checks to see where the mouse is
    // 
    ...
    //
    // MouseButtonUp handler that is defined within
    // the render function
    // 
